...
namespace Visitor_Security_Clearance_System.CosmosDB
{
    public class CosmosDBService : ICosmoseDBService 
    {
        ...
        {
            var response = _container.GetItemLinqQueryable<ManagerEntity>(true).Where(q => q.UserId == uid &&
        ...
        public async Task<OfficeEntity> GetOfficeEntityByUId(string userid)
        {
            var response = _container.GetItemLinqQueryable<OfficeEntity>(true).Where(q => q.UserId == userid &&
        ...
        {
            var response = _container.GetItemLinqQueryable<PassEntity>(true).Where(q => q.UserId == uid &&
        ...
        {
            var response = _container.GetItemLinqQueryable<SecurityEntity>(true).Where(q => q.UserId == uid &&
        ...
        public async Task<VisitorEntity> GetVisitorEntityByUId(string userid)
        {
            var response = _container.GetItemLinqQueryable<VisitorEntity>(true).Where(q => q.UserId == userid &&
        ...
        {
            var response = _container.GetItemLinqQueryable<PassEntity>(true).Where(q =>q.UserId == officeid && q.IsApproved == isApproved &&
            q.Active && q.Archived == false && q.DocumentType == Credentials.PassDocumentType).ToList();
            return response;
        }
    }
